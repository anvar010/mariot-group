...
const HUB_SERVICES = [
  { title: 'Business / Trade Account', desc: 'Open a trade account and enjoy ongoing B2B support.', cta: 'Apply for Account', link: '/contact' },
  { title: 'Kitchen Consultation & Site Visit', desc: 'Free consultation with a specialist and on-site inspection.', cta: 'Book Consultation', link: '/consultation' },
  { title: 'Restaurant & Cafe Opening', desc: 'End-to-end launch support for new food service businesses.', cta: 'Start My Project', link: '/restaurant-opening' },
  { title: 'Urgent Equipment Request', desc: 'Fast-track supply when your kitchen can’t wait.', cta: 'Send Urgent Request', link: '/urgent-request' },
];
...
const PACKAGES = [
  ...
  { title: 'Cafe Equipment', desc: 'Everything you need to launch a cafe.' },
          ...
          <ScrollReveal>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '1.5rem', marginBottom: '3.5rem' }}>
              <div style={{ maxWidth: '640px' }}>
                ...
                <h2 className="h2" style={{ marginTop: '1.25rem', color: 'var(--paper)' }}>Business solutions for restaurants, cafes, hotels &amp; commercial kitchens</h2>
              </div>
            ...
            {HUB_SERVICES.map((service, i) => (
              <ScrollReveal key={service.title} delay={i * 100}>
                <div className="cat-card hub-card" style={{ backgroundColor: 'var(--ink)', padding: 'clamp(1.75rem, 3vw, 2.5rem)', height: '100%', display: 'flex', flexDirection: 'column', gap: '1rem', minHeight: '260px' }}>
                  ...
                  <Link href={service.link} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: i % 2 === 0 ? 'var(--primary)' : 'var(--accent)', fontWeight: 700, fontSize: '0.8rem', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
